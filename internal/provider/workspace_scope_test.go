...
func TestWorkspaceScopeIsAvailableAcrossManagedResources(t *testing.T) {
	...
	resources := []struct {
		...
		{name: "run_template", factory: newRunTemplateResource},
...
func TestWorkspaceScopeIsAvailableAcrossResourceDataSources(t *testing.T) {
	...
	dataSources := []struct {
		...
		{name: "run_template", factory: newRunTemplateDataSource},
		{name: "run_templates", factory: newRunTemplatesDataSource},
